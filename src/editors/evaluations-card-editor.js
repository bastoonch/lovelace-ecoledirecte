...
class EcoleDirecteEvaluationsCardEditor extends BaseEcoleDirecteCardEditor {
    render() {
...
customElements.define("ecoledirecte-evaluations-card-editor", EcoleDirecteEvaluationsCardEditor);
