...
class EcoleDirecteDelaysCardEditor extends BaseEcoleDirecteCardEditor {
    render() {
...
customElements.define("ecoledirecte-delays-card-editor", EcoleDirecteDelaysCardEditor);
