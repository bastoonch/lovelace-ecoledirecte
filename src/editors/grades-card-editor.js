...
class EcoleDirecteGradesCardEditor extends BaseEcoleDirecteCardEditor {
    render() {
...
customElements.define("ecoledirecte-grades-card-editor", EcoleDirecteGradesCardEditor);
