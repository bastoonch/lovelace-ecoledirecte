...
class EcoleDirecteHomeworkCardEditor extends BaseEcoleDirecteCardEditor {
    render() {
...
customElements.define("ecoledirecte-homework-card-editor", EcoleDirecteHomeworkCardEditor);
