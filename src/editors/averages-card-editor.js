...
class EcoleDirecteAveragesCardEditor extends BaseEcoleDirecteCardEditor {
    render() {
...
customElements.define("ecoledirecte-averages-card-editor", EcoleDirecteAveragesCardEditor);
